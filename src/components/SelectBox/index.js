...
const sizes = {
  ...
  md: "lg:p-[16px] xl:p-[18px] p-[21px] 3xl:p-[25px]",
  lg: "lg:pb-[14px] xl:pb-[16px] pb-[18px] 3xl:pb-[21px] lg:pt-[17px] xl:pt-[20px] pt-[23px] 3xl:pt-[27px] lg:px-[14px] xl:px-[16px] px-[18px] 3xl:px-[21px]",
};
