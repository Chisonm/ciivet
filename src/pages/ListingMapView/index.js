    ...
    <>
      <Column className="bg-white_A700 font-manrope items-center justify-end mx-[auto] lg:pt-[13px] xl:pt-[15px] 2xl:pt-[17px] 3xl:pt-[20px] w-[100%]">
        ...
        <Column className="items-center lg:mt-[14px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[100%]">
          <Column className="bg-gray_52 justify-end lg:p-[28px] xl:p-[32px] 2xl:p-[37px] 3xl:p-[44px] w-[100%]">
            <Text className="font-extrabold lg:ml-[64px] xl:ml-[73px] 2xl:ml-[83px] 3xl:ml-[99px] lg:mt-[27px] xl:mt-[31px] 2xl:mt-[35px] 3xl:mt-[42px] lg:text-[28px] xl:text-[32px] 2xl:text-[36px] 3xl:text-[43px] text-gray_900 tracking-ls1 w-[auto]">
              Find Property
            </Text>
            <Row className="items-center lg:ml-[64px] xl:ml-[73px] 2xl:ml-[83px] 3xl:ml-[99px] lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] w-[87%]">
              <Input
                value={inputvalue}
            ...
            <Row className="items-center lg:ml-[64px] xl:ml-[73px] 2xl:ml-[83px] 3xl:ml-[99px] mr-[auto] xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] lg:mt-[9px] w-[68%]">
            ...
            <Column
              className="bg-cover bg-repeat items-center justify-end lg:ml-[64px] xl:ml-[73px] 2xl:ml-[83px] 3xl:ml-[99px] lg:mt-[31px] xl:mt-[36px] 2xl:mt-[41px] 3xl:mt-[49px] lg:p-[24px] xl:p-[28px] 2xl:p-[32px] 3xl:p-[38px] rounded-radius10 w-[88%]"
              style={{
                backgroundImage: "url('images/img_group100000142.png')",
              }}
            >
              <Column
                className="bg-cover bg-repeat items-end 2xl:mt-[11px] 3xl:mt-[13px] lg:mt-[8px] xl:mt-[9px] lg:p-[51px] xl:p-[58px] 2xl:p-[66px] 3xl:p-[79px] w-[94%]"
                style={{ backgroundImage: "url('images/img_group738.svg')" }}
              >
                <Column className="bg-white_A700 border border-bluegray_100 border-solid justify-center lg:my-[14px] xl:my-[16px] 2xl:my-[19px] 3xl:my-[22px] lg:p-[15px] xl:p-[17px] 2xl:p-[20px] 3xl:p-[24px] rounded-radius10 w-[32%]">
            ...
            <Grid className="lg:gap-[18px] xl:gap-[21px] 2xl:gap-[24px] 3xl:gap-[28px] grid grid-cols-3 lg:ml-[64px] xl:ml-[73px] 2xl:ml-[83px] 3xl:ml-[99px] lg:mt-[46px] xl:mt-[53px] 2xl:mt-[60px] 3xl:mt-[72px] w-[88%]">
              <Column className="bg-white_A700 border border-bluegray_100 border-solid lg:pb-[23px] xl:pb-[26px] 2xl:pb-[30px] 3xl:pb-[36px] rounded-radius10 w-[100%]">
                <Img
            ...
            <Row className="items-center lg:ml-[64px] xl:ml-[73px] 2xl:ml-[83px] 3xl:ml-[99px] lg:mt-[62px] xl:mt-[71px] 2xl:mt-[80px] 3xl:mt-[96px] w-[87%]">
              <Button
